...
完整示例见[`examples/对象与类型判断.yx`](examples/对象与类型判断.yx)、[`examples/扩展标准库.yx`](examples/扩展标准库.yx)、[`examples/后1.0标准库.yx`](examples/后1.0标准库.yx)与[`examples/1.1标准库.yx`](examples/1.1标准库.yx)。
